  ...
  <div>
    ...
    <ul>
      <li>
        ...
        <a href="mailto:rd.pierrepoivre@gmail.com" target="_blank">rd.pierrepoivre@gmail.com</a>
      </li>
      <li>
        <i class="fa fa-linkedin fa-lg fa-fw" style="vertical-align: -5%;"></i>
        <a href="https://www.linkedin.com/in/rapha%C3%ABl-d-372695224/" target="_blank">linkedin.com/in/raphaël-d</a>
      </li>
      <li>
        <i class="fa fa-github fa-lg fa-fw"></i>
        <a href="https://github.com/RaphDUC" target="_blank">github.com/RaphDUC</a>
      </li>
      <li>
