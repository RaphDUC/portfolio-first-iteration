...
export default [
    new ProjectData("project-6", "Cyberpunk Souvenirs", "img/projects/project-CB-icon.png", `
    <div class="paragraph">
    ...
    `, "#c10606", false, true),
    new ProjectData("project-7", "The Primitive Island", "img/projects/project-PRIMIT-icon.png", `
    <div class="paragraph">
    ...
    new ProjectData("project-8", "Projet Loustic", "img/projects/project-LOUST-icon.png", `
    <div class="paragraph">
    ...
    new ProjectData("project-9", "En Haut", "img/projects/project-HAUT-icon.png", `
     <div class="paragraph">
